...
if __name__ == "__main__": 
    ...
    df = pd.DataFrame(R, columns=['長和','中電控股','香港中華煤氣','九龍倉集團','滙豐控股','電能實業','恒生銀行','恒基地產','新鴻基地產','新世界發展','太古股份公司A','東亞銀行','銀河娛樂','港鐵公司','信和置業','恒隆地產','昆侖能源','招商局港口','中國旺旺','吉利汽車','中信股份','國泰航空','中國石油化工股份','香港交易所','中國海外發展','騰訊控股','中國聯通','領展房產基金','華潤電力','中國石油股份','中國海洋石油','建設銀行','中國移動','聯想集團','長江基建集團','恒安國際','中國神華','華潤置地','長實地產','友邦保險','工商銀行','百麗國際','金沙中國有限公司','瑞聲科技','中國平安','蒙牛乳業','中銀香港','中國人壽','交通銀行','中國銀行'])
    ...
    approximate_df = pd.DataFrame(approximate_matrix, columns=['長和','中電控股','香港中華煤氣','九龍倉集團','滙豐控股','電能實業','恒生銀行','恒基地產','新鴻基地產','新世界發展','太古股份公司A','東亞銀行','銀河娛樂','港鐵公司','信和置業','恒隆地產','昆侖能源','招商局港口','中國旺旺','吉利汽車','中信股份','國泰航空','中國石油化工股份','香港交易所','中國海外發展','騰訊控股','中國聯通','領展房產基金','華潤電力','中國石油股份','中國海洋石油','建設銀行','中國移動','聯想集團','長江基建集團','恒安國際','中國神華','華潤置地','長實地產','友邦保險','工商銀行','百麗國際','金沙中國有限公司','瑞聲科技','中國平安','蒙牛乳業','中銀香港','中國人壽','交通銀行','中國銀行'])
